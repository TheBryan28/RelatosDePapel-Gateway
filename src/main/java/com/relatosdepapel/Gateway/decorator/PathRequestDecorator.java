...
@Slf4j
public class PathRequestDecorator  extends ServerHttpRequestDecorator {

    private final GatewayRequest gatewayRequest;
    private final ObjectMapper objectMapper;

    public PathRequestDecorator(GatewayRequest gatewayRequest, ObjectMapper objectMapper) {
